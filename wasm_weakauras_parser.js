/* @ts-self-types="./wasm_weakauras_parser.d.ts" */

/**
 * @param {string} wa_string
 * @returns {string}
 */
function decode(wa_string) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(wa_string, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./wasm_weakauras_parser_bg.js": import0,
    };
}
